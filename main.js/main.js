;(() => {
  ...
  function e(t, e, i) {
    ...
    function o(a) {
      t.contains(a.target) ||
        (t.removeAttribute(n, ' '),
        e.forEach((t) => {
          s.removeEventListener(t, o)
        }),
        i())
    }
    t.hasAttribute(n) ||
      (e.forEach((t) => {
        setTimeout(() => s.addEventListener(t, o))
      }),
      t.setAttribute(n, ' '))
  }
  class i {
    constructor(t, e, i) {
      ;(this.numeros = document.querySelectorAll(t)),
        (this.observerTarget = document.querySelector(e)),
        (this.observerClass = i),
    ...
    static incrementarNumero(t) {
      ...
      const n = setInterval(() => {
        ;(s += i),
          (t.innerText = s),
          s > e && ((t.innerText = e), clearInterval(n))
      }, 25 * Math.random())
    }
    animaNumeros() {
  ...
  new (class {
    constructor(t, e) {
      ;(this.linksInternos = document.querySelectorAll(t)),
        (this.options =
          void 0 === e ? { behavior: 'smooth', block: 'start' } : e),
    ...
    new (class {
      constructor(t, e) {
        ;(this.tabMenu = document.querySelectorAll(t)),
          (this.tabContent = document.querySelectorAll(e)),
          (this.activeClass = 'ativo')
      }
      activeTab(t) {
        ...
        const e = this.tabContent[t].dataset.anime
        this.tabContent[t].classList.add('ativo', e)
      }
      addTabNavEvent() {
        this.tabMenu.forEach((t, e) => {
          t.addEventListener('click', () => {
            this.activeTab(e)
          })
        })
    ...
    new (class {
      constructor(t, e, i) {
        ;(this.botaoAbrir = document.querySelector(t)),
          (this.botaoFechar = document.querySelector(e)),
          (this.containerModal = document.querySelector(i)),
    ...
    new (class {
      ...
      criarToolTipBox(t) {
        ...
        ;(e.innerText = i), document.body.appendChild(e), (this.tooltipBox = e)
      }
    ...
    new (class {
      constructor(e) {
        ;(this.sections = document.querySelectorAll(e)),
          ...
          (this.checkDistance = t(this.checkDistance.bind(this), 50))
      }
      getDistance() {
        this.distance = [...this.sections].map((t) => {
          const e = t.offsetTop
          return { element: t, offset: Math.floor(e - this.windowMetade) }
        })
      }
      checkDistance() {
    ...
    new (class {
      constructor(t, e) {
        ;(this.dropdownMenus = document.querySelectorAll(t)),
          ...
          (this.events = void 0 === e ? ['click', 'touchstart'] : e)
      }
      ...
      addDropdownMenusEvent() {
        this.dropdownMenus.forEach((t) => {
          this.events.forEach((e) => {
            t.addEventListener(e, this.activeDropdownMenu)
          })
        })
      }
      init() {
    ...
    new (class {
      constructor(t, e, i) {
        ;(this.menuButton = document.querySelector(t)),
          (this.menuList = document.querySelector(e)),
          (this.activeClass = 'active'),
          (this.events = void 0 === i ? ['click', 'touchstart'] : i),
          (this.openMenu = this.openMenu.bind(this))
      }
      openMenu() {
        this.menuList.classList.add(this.activeClass),
          this.menuButton.classList.add(this.activeClass),
          e(this.menuList, this.events, () => {
    ...
    new (class {
      ...
      init() {
        return (
          this.funcionamento &&
            (this.dadosFuncionamento(), this.dadosAgora(), this.ativaAberto()),
          this
        )
      }
    })('[data-semana]', 'active').init(),
    (function (t, e) {
      const s = document.querySelector('.numeros-grid')
      !(async function () {
        try {
  ...
  const s = new (class extends class {
    ...
    onStart(t) {
      ...
      'mousedown' === t.type
        ? (t.preventDefault(),
          ...
          (e = 'mousemove'))
        : ((this.dist.startX = t.changedTouches[0].clientX), (e = 'touchmove')),
    ...
    bindEvents() {
      ;(this.onStart = this.onStart.bind(this)),
        ...
        (this.onResize = t(this.onResize.bind(this), 200)),
    ...
    constructor(t, e) {
      super(t, e), this.bindControlEvents()
    }
    addArrow(t, e) {
    ...
    createControl() {
      ...
      return (
        ...
        this.slideArray.forEach((e, i) => {
          t.innerHTML += `<li><a href="#slide${i + 1}">${i + 1}</a></li>`
        }),
    ...
    eventControl(t, e) {
      t.addEventListener('click', (t) => {
        t.preventDefault(), this.changeSlide(e)
      }),
  ...
  s.init(), s.addControl('.custom-controls')
})()
